...
import sys
#sys.path.append('/home/gavin/Desktop/Django3server/Django/myproject/DemoProject/models/')
from DemoProject.models import MySQL_model as md
###### show view ######
...
def SQL_all(request,page=1):
    ...
    arr=[]
    for i in a[StartPoint:60+StartPoint]:
        eachdiv={}
        eachdiv["id"] = i[0]
